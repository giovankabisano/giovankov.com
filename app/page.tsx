...
export const metadata: Metadata = {
  ...
  description:
    "Giovanka Bisano Portfolio | Engineering Manager | Software Engineer, Android & Frontend | Kotlin, React Native, React JS, Next JS, Go",
  icons: {
    icon: {
      url: "/favicon.ico",
      rel: "icon",
  ...
  authors: {
    name: "Giovanka Bisano Putra",
    url: "https://www.linkedin.com/in/giovankabisano/",
  },
  generator: "Next.js",
  keywords: [
    "giovanka",
